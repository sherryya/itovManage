...
import dwz.persistence.mapper.TerminalInfoMapper;
...
public class UserServiceMgrImpl extends AbstractBusinessObjectServiceMgr
	...
	@Autowired
	private TerminalInfoMapper terminalmapperMapper;
	...
	/**
	 * 查询terminal_imei列表 生成二维码使用
	 */
	@Override
	public List<TerminalInfo> queryTerminalList(TerminalInfo terminal) {
		// TODO Auto-generated method stub
		return terminalmapperMapper.queryTerminalList(terminal);
	}
	/**
	 * 查询总条数
	 */
	public int queryCountTerminalList()
	{
		return terminalmapperMapper.queryCountTerminalList();
	}
