...
<script src="<c:url value='/styles/dwz/js/dwz.navTab.js'/>" type="text/javascript"></script>
<script src="<c:url value='/styles/management/misc.js'/>" type="text/javascript"></script>

<%--<script src="<c:url value='/styles/dwz/js/CreateControl.js'/>" type="text/javascript"></script>
<script src="<c:url value='/styles/dwz/js/GRInstall.js'/>" type="text/javascript"></script>
	...
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				...
				<ul class="nav">
					<li><a href="<c:url value='/personalmanagement/personal/updpwd'/>" target="dialog" width="600">密码设置</a></li>
					<li><a href="<c:url value='/'/>" target="website">重新登录</a></li>
						...
						<ul class="tree treeFolder">
							<li><a>用户管理</a>
								 <ul>
									...
									<li><a href="<c:url value='/personalmanagement/personal/list'/>" target="navTab" rel="personal">坐席管理</a></li>
						            <li><a href="<c:url value='/personalmanagement/personal/list1'/>" target="navTab" rel="personal1">终端用户管理</a></li>
								</ul>
							</li>
						</ul>
					</div>  --%> 
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="<c:url value='/management/website/edit'/>"
								target="navTab" rel="websiteNav">网站装修</a>
							</li>
							<li><a href="<c:url value='/management/webpage/list'/>"
								target="navTab" rel="pageLiNav">页面管理</a>
							</li>
						</ul>
					</div>
					<div class="accordionHeader">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="<c:url value='/management/news'/>"
								target="navTab" rel="newsLiNav">资讯管理</a>
							</li>
							<li><a href="<c:url value='/management/test'/>"
								target="navTab" rel="testLiNav">测试管理</a>
							</li>
						</ul>
					</div>  --%>
