		...
		<ul class="searchContent">
			...
			<li>
				...
				<select name="type">
					...
					<option value="${item}" ${item.id eq param.type ? 'selected="selected"' : ''}>${item.name}</option>
					</c:forEach>
				</select>
			</li>
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" target="navTab" rel="newsNav" href="<c:url value='/management/news/add'/>" title="添加新闻"><span>添加</span></a></li>
			...
			<li><a class="delete" target="ajaxTodo" href="<c:url value='/management/news/delete/{slt_newsId}'/>" title="您确定要删除吗?"><span>删除</span></a></li>
